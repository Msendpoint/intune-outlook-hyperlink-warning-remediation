<#
.SYNOPSIS
    One-click installer and launcher for Outlook Hyperlink Warning Remediation and Trusted Sites Configuration via Intune
...
Write-Host "    Outlook Hyperlink Warning Remediation and Trusted Sites Configuration via Intune" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-outlook-hyperlink-warning-remediation.ps1"
